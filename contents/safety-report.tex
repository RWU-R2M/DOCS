...
\section{Basic Electric Layout}
    ...
    \caption{The wiring diagram incorporates several different aspects about how the rover is wired up, including the individual cross-sections, voltages and physical location of connections.}
    \label{wiring_power}
    \end{figure}
