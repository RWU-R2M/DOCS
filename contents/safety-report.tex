...
\section{Power Architecture}
    ...
    The main layout of the electric construction is built around the fundamental principle of the parallel power system in the rover, whose benefits have already been discussed. The main energy storage contains two unregulated 24V (6S) and 12V (3S) power sources in the form of LiPo batteries. which are fed into an emergency stop system. This system's 

 
    
    \begin{figure}[h]
    \includegraphics[width=\textwidth]{contents/figures/power-architecture.png}
