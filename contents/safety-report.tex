...
\section{Power Architecture}
    ...
    \caption{The wiring diagram incorporates several different aspects about how the rover is wired up. This includes individual cross-sections, voltages and physical location of connections. A detailed listing is given in the follwowing pages.}
    \label{wiring_power}
    \end{figure}
