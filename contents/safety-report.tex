\section{Copyright Notice \& License}
    ...
    All publications are referenced with the DOI under: \\
...
\section{Wiring diagram}
    ...
    In this naming convetion, the current rating and trip-behaviour is given as a variable. The special thermal-triggered fuses will be refered to as "TCP" (= Thermal Circuit Protection).There are 2 different trip-reponse-characteristics for TCPs supplied by "Phoenix Contact", being fast and medium fast. 
